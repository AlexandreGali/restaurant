    ...
    <div class="droite-haut">
      ...
      <form method="post" action="#">
            <div class="formumu">                
                ...
                <div class="form1">
                    <input type="text" id="courriel" name="courriel" placeholder="Courriel">
                </div>
                <div class="form1">
                    <input type="text" id="telephone" name="telephone" placeholder="Téléphone">
                </div>
                <div class="form1">
                    <input type="text" id="personnes" name="personnes" placeholder="Nombre de personnes">
                </div>
                <div class="form1">
                    <input type="text" id="repas" name="repas" placeholder="Type de repas voulus">
                </div>
                <div class="form1">
                    <input type="text" id="date" name="date" placeholder="Date de l'évènement">
                </div>
                <div class="form2">
